...
<body>
	...
	<div class="grey-back">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4">
					<h1 style='color:#1688c9;'>¡Gracias por dejar tus datos!</h1> <h3>Nos contactaremos con vos.</h3>
					<p style="font-size:11px;"><strong>asegurARTe</strong> garatiza la absoluta confidencialidad de los datos perosnales recavados.</p>
				</div>
				<div class="col-md-8">
